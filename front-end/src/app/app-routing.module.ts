...
const routes: Routes = [
  ...
  { path: 'upload', component: TestComponent, canActivate: [AuthGuard] },
  { path: 'sign-in', component: TestComponent },
  { path: 'add-ingredients', component: TestComponent, canActivate: [AuthGuard] },
  { path: 'add-method', component: TestComponent, canActivate: [AuthGuard] },
